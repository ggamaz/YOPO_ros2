...
void Quadrotor::operator()(const Quadrotor::InternalState &x,
  ...
  // for (int i = 0; i < 4; ++i)
  //   AOA[i]   = alpha0 - atan2(motor_linear_velocity[i],
  //   blade_linear_velocity[i]) * 180 / 3.14159265;
  // //! @todo end
...
const Quadrotor::State &Quadrotor::getState(void) const { return state_; }
...
double Quadrotor::getMass(void) const { return mass_; }
void Quadrotor::setMass(double mass) { mass_ = mass; }

double Quadrotor::getGravity(void) const { return g_; }
void Quadrotor::setGravity(double g) { g_ = g; }

const Eigen::Matrix3d &Quadrotor::getInertia(void) const { return J_; }
...
double Quadrotor::getArmLength(void) const { return arm_length_; }
...
double Quadrotor::getPropRadius(void) const { return prop_radius_; }
...
double Quadrotor::getPropellerThrustCoefficient(void) const { return kf_; }
...
double Quadrotor::getPropellerMomentCoefficient(void) const { return km_; }
...
double Quadrotor::getMaxRPM(void) const { return max_rpm_; }
...
double Quadrotor::getMinRPM(void) const { return min_rpm_; }
...
Eigen::Vector3d Quadrotor::getAcc() const { return acc_; }
} // namespace QuadrotorSimulator
